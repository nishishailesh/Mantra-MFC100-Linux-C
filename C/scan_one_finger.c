...
//gcc scan_one_finger.c -liengine_ansi_iso -lMFS100V9022 -lstdc++ -lpthread -ldl -lrt -lusb -lm -o my_scan_one_finger
...
int scan_one_finger(void *device)
{
	...
	Img_Write_to_file(FinalFrame1,"data.bmp",height,width);
    Write_Template_ISO_ANSI(Iso_19794_2_Template1,"data.fmr",ISOTemplateLength1);
